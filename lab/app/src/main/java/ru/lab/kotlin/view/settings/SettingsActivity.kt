package ru.lab.kotlin.view.settings
...
import ru.lab.kotlin.utils.SharedPreference
...
class SettingsActivity : AppCompatActivity() {
    ...
    private fun saveSettings() {
        ...
        Snackbar.make(requireViewById(android.R.id.content), "Настройки сохранены", Snackbar.LENGTH_LONG).show()
    }
